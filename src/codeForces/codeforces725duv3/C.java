 ...
 // =================================================================================================
     ...
     public static void main(String[] args) {
        ...
        while(t-->0){
            ...
            ruffleSort(a);
            l = Math.max(l , a[0] + a[1]);
            r = Math.min(r , a[n - 2] + a[n - 1]);
 
            long tot = 0;
            for(int i = 0; i < n - 1; i++){
                tot += upperIndex(a, n , r - a[i] , i) -
                lowerIndex(a, n , l - a[i] , i) + 1L;
            }
            System.out.println(tot);
        }
     }
     // function to find first index >= x
     static long lowerIndex(long arr[], int n, long x , int i)
    {
        int l = i + 1, h = n - 1;
        while (l <= h)
        {
    ...
    static int upperIndex(long arr[], int n, long y , int i)
    {
        int l = i + 1, h = n - 1;
        while (l <= h)
        {
