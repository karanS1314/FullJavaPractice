package codeForces.virtual.cf709div1;
 ...
 public static void main(String[] args) {
    ...
    o:while(t-->0){
        ...
        for(int i = 0; i < m; i++){
            for(int j = 0; j < ar[vec.get(i).a].size(); j++){
                if(count[ar[vec.get(i).a].get(j)] < (m + 1) / 2){
                    res[vec.get(i).a] = (ar[vec.get(i).a].get(j));
                    count[ar[vec.get(i).a].get(j)]++;
                    break;
                }
            }
        }
