 ...
 //==================================================================================================
     ...
     public static void main(String[] args) {
        ...
        while(t-->0){
            ...
            long a1[] = sc.readLongArray(n1);
            long a2[] = sc.readLongArray(n2);
            long a3[] = sc.readLongArray(n3);
            ...
            long mi1 = Math.min(sum1 , Math.min(sum2 , sum3));
            long mi2 = Math.min(a1[0] + a2[0] , Math.min(a2[0] + a3[0] , a3[0] + a1[0]));

            long mi = Math.min(mi1 , mi2);
            System.out.println(sum1 + sum2 + sum3 - 2 * mi);
        }
     }
