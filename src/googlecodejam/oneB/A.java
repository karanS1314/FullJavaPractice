 ...
 public class A {
     public static void main(String[] args) {
        ...
        while(t-->0){
            ...
            long x = (a)/(fastPow(10, 10) * 12)/100;
            long y = (b)/(fastPow(10, 10) * 12)/100;
            long z = (c)/(fastPow(10, 10) * 12)/100;
            ...
            if(x%6 == 0){
                ...
                System.out.println("Case #"+ tc+ ": "+ z2 + " " + y2 + " " + x2 + " " + 0 );
            }
            else if(y%6 == 0){
                x2 = y/6;
                y2 = x/6;
                ...
                y2 = y/6;
                x2 = z/6;
                n2 = ((z*1.0)%6)/6*fastPow(10, 9);
                System.out.println("Case #"+ tc+ ": "+ z2 + " " + y2 + " " + x2 + " " + n2 );
            }
        }
     }
