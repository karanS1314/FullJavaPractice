package codeForces.codeforces733;
 ...
 //==================================================================================================
     static class CC implements Comparator<Integer>{
     ...
     public static void main(String[] args) {
        ...
        while(t-->0){
            ...
            int res = solve(n , pa , pb);

            System.out.println(res);
        }
     }

     static int solve(int n , int pa[] , int pb[]){
        int l = 0;
        int r = 1_000_000;
        int mid = 0;
        while(l < r){
            mid = l + (r - l) / 2; // extra rounds
            int tot = (n + mid) - (n + mid) / 4; 
            int ax = Math.max(tot - mid , 0);
            int bx = Math.min(tot , n);

            int ay = mid * 100 + pa[ax];
            int by = pb[bx];
