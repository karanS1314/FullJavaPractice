package codeForces.virtual.cf698;
 ...
 //==================================================================================================
    ...
    main:while(t-->0){
            ...
            long sum = 0;
            for(int j = n - 1; j >= 0; j--){
                long x = (dd[j] - sum) / (long)(j + 1);
                if((dd[j] - sum) % (long)(j + 1) != 0 || x <= 0 || set.contains(x)){
                    System.out.println("NO");
                    continue main;
                }
                set.add(x);
