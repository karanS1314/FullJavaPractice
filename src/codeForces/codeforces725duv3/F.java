 ...
 // =================================================================================================
     ...
     public static void main(String[] args) {
        ...
        while(t-->0){
            ...
            int ll = ls.length();
            int rl = rs.length();
            if(ll != rl || rs.charAt(0) != ls.charAt(0)){
                String lps = "";
                for(int i = 0; i < ll; i++){
                    lps += "1";
                }
                String lc = ls.substring(0 , 1);
                for(int i = 0; i < ll - 1; i++){
                    lc += "0";
                }
                long lp = Long.parseLong(lps); 

                String rps = "";
                for(int i = 0; i < rl; i++){
                    rps += "1";
                }
                String rc = rs.substring(0 , 1);
                for(int i = 0; i < rl - 1; i++){
                    rc += "0";
                }
                long rp = Long.parseLong(rps); 

                long res = Character.getNumericValue(rs.charAt(0)) * rp - Character.getNumericValue(ls.charAt(0)) *lp;
                ...
                while(lci < l){
                    lci++;
                    if(lci % 10 == 0){
                        count += (long)(Math.log(lci) / Math.log(10)) + 1L;
                    }
                    else{
                        count++;
                    }
                ...
                while(rci < r){
                    rci++;
                    if(rci % 10 == 0){
                        count += (long)(Math.log(rci) / Math.log(10)) + 1L;
                    }
                    else{
                        count++;
                    }
            ...
            while(l < r){
                l++;
                if(l % 10 == 0){
                    count += (long)(Math.log(l) / Math.log(10)) + 1L;
                }
                else{
                    count++;
                }
