package codeForces.virtual.edu102;
 ...
 //==================================================================================================
     ...
     public static void main(String[] args) {
        ...
        while(t-->0){
            ...
            for(int i = (int)k; i < n; i++){ // 0 se k - 1 index tk i need all numbers from
                // 1 to k in b and i can put k in b from k to n index
                b[i] = k;
            }
            long invA = (n - k) * (n - k + 1); 
            invA /= 2; // inversions in A
            long count = 0;
            int ind = -1;
            ...
            long temp = k - ind;
            int storI = -1;
            for(int i = (int)k - 1; i >= 0; i--){ // putting max inversions possible in b
                // from k - 1 index to the index where its inversions are just smaller than total A inversions
                b[i] = temp++;
                if(temp == k + 1){
                    storI = i;
                    break;
            ...
            for(int i = 0; i < storI; i++){ // as i need all numbers from 1 to k in b from 0 to k - 1 index
                b[i] = i + 1;
            }
            // b is ready 
            // prepare p accordingly
