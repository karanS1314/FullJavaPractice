package codeForces.virtual.cf715div1;
 ...
 // << smallest super substring/subsequence , LCS concept , maths >>
     ...
     public static void main(String[] args) {
        ...
        while(t-->0){
            ...
            while(l < x.length() && r < y.length()){
                while(l < x.length() && x.charAt(l) != code){
                    res.append(x.charAt(l));
                    l++;
                }
                if(l == x.length()) break;

                while(r < y.length() && y.charAt(r) != code){
                    res.append(y.charAt(r));
                    r++;
                }
                if(r == y.length()) break;
