package codeForces.Practicer;
 ...
 public class KingEscape {
     ...
     static boolean valid(int mat[][] , int i , int j , Pair a , int dp[][]){
        ...
        int n = mat.length;
        for(int l=a.a+1,m=a.b+1;l<=n&&m<=n;l++,m++){
            if(i==a.a && j==a.b){
                dp[i][j] = -1;
                return false;
            }
        }
        for(int l=a.a-1,m=a.a+1;l>=1&&m<=n;l--,m++){
            if(l==a.a && m==a.b){
                dp[i][j] = -1;
                return false;
            }
        }
        for(int l=a.a-1,m=a.b-1;l>=1&&m>=1;l--,m--){
            if(l==a.a && m==a.b){
                dp[i][j] = -1;
                return false;
            }
        }
        for(int l=a.a+1,m=a.b-1;l<=n&&m>=1;l++,m--){
            if(l==a.a && m==a.b){
                dp[i][j] = -1;
                return false;
            }
