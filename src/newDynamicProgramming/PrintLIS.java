 ...
 //==================================================================================================
     ...
     public static void solution(int []a){
        // write your code here
            ...
            q.add(new Pair(mxI , Integer.toString(a[mxI])));
            while(q.size() > 0){
                Pair front = q.poll();
                if(front.ind == 0){
                ...
                for(int i = 0; i < front.ind; i++){
                    if((a[front.ind] > a[i]) && (dp[i] == dp[front.ind] - 1)){
                        q.add(new Pair(i , a[i] + " -> " + front.psf));
                    }
                }
            }
            System.out.println();
