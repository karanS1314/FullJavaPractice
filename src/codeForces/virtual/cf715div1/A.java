package codeForces.virtual.cf715div1;
 ...
 //==================================================================================================
     static int csb(long n){ // kernighans algo
        int count = 0;
        long x = ~n+1;
        long rsbm = (n&x);
        while(rsbm != 0){
     ...
     public static void main(String[] args) {
        ...
        while(t-->0){
            ...
            long da = Long.parseLong(a , 2);
            long db = Long.parseLong(b , 2);
            long dc = Long.parseLong(c , 2);
            ...
            if(cx < Math.min(cy , cz)){ // cx is min
                StringBuilder sa = new StringBuilder(a);
                StringBuilder first = new StringBuilder("");

                StringBuilder sx = new StringBuilder(Long.toBinaryString(x));
                System.out.println(sx + " ........1");
                for(int i = 0; i < sx.length(); i++){
                    if(sx.charAt(i) == '1'){
                        first.append(b.charAt(i));
                    }
                }
                first.append(sa);
                System.out.println(first);
            }
            else if(cy < Math.min(cx , cz)){ // cy is min
                StringBuilder sb = new StringBuilder(b);
                StringBuilder first = new StringBuilder("");

                StringBuilder sy = new StringBuilder(Long.toBinaryString(y));
                System.out.println(sy + " ........2");
                for(int i = 0; i < sy.length(); i++){
                    if(sy.charAt(i) == '1'){
                        first.append(c.charAt(i));
                    }
                }
                first.append(sb);
                System.out.println(first);
            }
            else if(cz < Math.min(cx , cy)){
                StringBuilder sa = new StringBuilder(a);
                StringBuilder first = new StringBuilder("");

                StringBuilder sz = new StringBuilder(Long.toBinaryString(z));
