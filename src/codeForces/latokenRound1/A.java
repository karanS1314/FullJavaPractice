package codeForces.latokenRound1;
 ...
 // =================================================================================================
     static boolean check(char a[][] , char b[][] , int n , int m){
        for(int i = 0; i < n; i++){
            for(int j = 0; j < m; j++){
        ...
        while(t-->0){
            ...
            if(ri == -1){
                ...
                if(wi == -1){
                    ...
                    if(ri % 2 == 0 && rj % 2 != 0){ // even rows odd cols
                        for(int i = 0; i < n; i++){
                            for(int j = 0; j < m; j++){
                                if(i % 2 == 0){
                                    if(j % 2 != 0){
                    ...
                    if(ri % 2 != 0 && rj % 2 == 0){ // odd rows even cols
                        for(int i = 0; i < n; i++){
                            for(int j = 0; j < m; j++){
                                if(i % 2 != 0){
                                    if(j % 2 == 0){
                    ...
                    if(ri % 2 != 0 && rj % 2 != 0){ // odd rows odd cols
                        for(int i = 0; i < n; i++){
                            for(int j = 0; j < m; j++){
                                if(i % 2 != 0){
                                    if(j % 2 != 0){
