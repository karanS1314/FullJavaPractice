package bitManipulation;
 ...
 public class ReducetoOne {
     ...
     // to write n%4 :
     // we should rather use bits,
     // the numbers of nature 4x+1 end with ......01 at the end of their bit representation
     // and the numbers of nature 4x+3 end with .....11
     // if we take & with 3 and if its ==1 then its of 4x+1 nature .
     // or if it returns ==3 then its of 4x+3 nature;
     
     /// theres a better way to compute 2 pow x that is 1<< x
